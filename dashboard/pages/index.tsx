  ...
  return (
    <Container>
      ...
      <Container style={{
        ...
        <Text h3 css={{ color: "$gray800" }}>An advanced discord music bot, supports Spotify, SoundCloud, YouTube with
          Shuffling, Volume Control and Web Dashboard!</Text>
        <Container css={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <Button color="primary" flat onClick={() => window.open("https://github.com/SudhanPlayz/Discord-MusicBot")}
                  style={{
                    marginTop: "1rem",
                    marginLeft: "20px"
                  }}>Github
      ...
      <Container
        css={{ marginTop: "30px", display: "flex", flexDirection: "column", alignItems: "center", minHeight: "60vh" }}>
